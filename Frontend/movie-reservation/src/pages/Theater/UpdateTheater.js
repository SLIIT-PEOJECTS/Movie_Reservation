...
const UpdateTheater = (props) => {
  ...
  const { name, address, city, close, noOfSeat, price } = state;
  ...
  useEffect(() => {
    axios
      ...
      .then((response) => {
        ...
        const { name, address, city, close, noOfSeat, price } = response.data;
      ...
      <div class="row">
        ...
        <div class="col">
          <div className="form-group">
            ...
            <input
              type="text"
              onChange={handleChange("noOfSeat")}
              value={noOfSeat}
              className="form-control"
              placeholder="Enter the Release Date"
              pattern="[0-9]+"
        ...
        <div class="col">
          <div className="form-group">
            ...
            <input
              ...
              value={price}
              className="form-control"
              placeholder="Enter the Hall Price (Rs.)"
              pattern="[0-9]+"
              title="Please enter only numbers"
              required
            />
  ...
  const handleSubmit = (event) => {
    ...
    axios
      .put(
        `http://localhost:8081/theater/${id}`,
        {
          name,
          address,
          city,
