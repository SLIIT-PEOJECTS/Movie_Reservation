...
function LoginScreen(props) {
    ...
    async function Login() {
        ...
        axios
            .post("http://localhost:8081/manager/login", { email, password })
            .then((mresponse) => {
                ...
                if (mresponse.data == null) {
                    ...
                    if (mresponse.data.accountStatus == "Pending") {
                        ...
                        axios
                            .get("http://localhost:8081/manager/token")
                            .then((response) => {
                    ...
                    <div className="row align-items-center justify-content-center">
                        <div class="col-lg-6">
                            <img
                                ...
                                style={{ height: 500, widows: 500 }}
                                class="img-fluid"
                                alt="Doccure Login"
                            />
                        </div>
                        <div className="col-lg-6">
                            <h2 style={{ fontSize: "35px", marginTop: "5px" }}>
                                {" "}
                                Manager Login{" "}
                            </h2>
                            <br />
