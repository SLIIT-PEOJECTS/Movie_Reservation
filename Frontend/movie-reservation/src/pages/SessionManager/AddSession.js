                                ...
                                <div class="row">
                                    <div class="col">
                                        <div className="form-group">
                                            ...
                                            <input onChange={handleChange('sessionName')} value={sessionName} type="text" className="form-control" placeholder="Enter the Session Name" required />
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="col">
                                            <div className="form-group">
                                                ...
                                                <input type="text" onChange={handleChange('fromTime')} value={fromTime} className="form-control" placeholder="Enter the session starting time" required />
                                            </div>
                                        </div>
                                        <div class="col">
                                        <div class="col">
                                            <div className="form-group">
                                                ...
                                                <input type="text" onChange={handleChange('toTime')} value={toTime} className="form-control" placeholder="Enter the session ending time" required />
                                            </div>
                                        </div>
                                        </div>
                                        {/* <div className="form-group">
